...
- **Used by:** [PluginInstance.cs](../../Legacy/Loader/PluginInstance.cs.md), [GitHubPlugin.cs](GitHubPlugin.cs.md), [LocalFolderPlugin.cs](LocalFolderPlugin.cs.md), [LocalPlugin.cs](LocalPlugin.cs.md), [ModPlugin.cs](ModPlugin.cs.md), [ObsoletePlugin.cs](ObsoletePlugin.cs.md), [Loader.cs](../Loader.cs.md), [PluginList.cs](../PluginList.cs.md), [PluginVotes.cs](../Votes/Model/PluginVotes.cs.md)
