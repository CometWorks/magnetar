...
**Project:** `ConfigTerminalTests` · **Files:** 10 · **Source lines:** 1465
...
| `UiSmokeTests` | class | [`ConfigTerminalTests/UiSmokeTests.cs`](../descriptions/ConfigTerminalTests/UiSmokeTests.cs.md) | Headless AppShell view-tree smoke test against Terminal.Gui FakeDriver, pumping the main loop and navigating each view. |
...
| [`ConfigTerminalTests/UiSmokeTests.cs`](../descriptions/ConfigTerminalTests/UiSmokeTests.cs.md) | 89 | Headless UI smoke test that builds the whole `AppShell` view tree against Terminal.Gui's `FakeDriver` and pumps a few main-loop iterations, catching constructor/layout exceptions without a real terminal. |
