...
namespace Magnetar.Config.State;

/// <summary>
/// The tool's own per-instance settings, persisted as a small XML
/// (<c>MagnetarConfig.xml</c>) next to Magnetar's <c>config.xml</c> in the
...
{
    private const string FileName = "MagnetarConfig.xml";
